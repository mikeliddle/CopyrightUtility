...
# NOTE: in addition to adding the user to the users.txt document, you must also create a folder in bitbucket for the user.
...
declare -r REPO_PATH_LOCATION='/opt/copyright_service/bitbucket'
...
function checkout_run_push {
	...
	$RUN_GIT push git@bitbucket.org:$2/$1
	echo 'git pushed'
}
...
function delete_and_clone {
	...
	$RUN_GIT clone git@bitbucket.com:$2/$repo_name
